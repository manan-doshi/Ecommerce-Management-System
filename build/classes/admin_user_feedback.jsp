...
<title>Admin Panel - Customer Issue</title>
<link rel="shortcut icon" href="img/admin.png" type="image/x-icon">
<link rel="stylesheet" href="css/admin_user_feedback.css">
  ...
  %>
	...
	<nav class="navbar navbar-dark bg-dark fixed-top">
		<div class="container-fluid">
			...
			<div class="admin_name">Customer Issue/Query</div>
	...
	try {
		...
		ResultSet rs = st.executeQuery("SELECT * FROM contact_us");
		while (rs.next()) {
	...
	%>
				...
				<tr>
					...
					<td><%=email%></td>
					<td><%=message%></td>
					<form action="./Admin_feedback_remove" method="post"
						onsubmit="return myFunction()">
						<td style="text-align: center"><input type="hidden"
							name="name" value="<%=name%>"> <input id="button1"
